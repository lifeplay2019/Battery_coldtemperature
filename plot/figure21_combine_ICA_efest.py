...
battery_dirs_labels = [
    ('../data/efset18650_procress/', '18650'),
    ('../data/efset21700_procress/', '21700'),
    ('../data/efset26650_procress/', '26650')
]

batches = ['P25', 'N10', 'N20']  # Batches to plot

# Custom titles for each subplot
titles = ['Efest Battery at 25°C',
          'Efest Battery at -10°C',
          'Efest Battery at -20°C']
